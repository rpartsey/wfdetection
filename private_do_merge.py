...
our_best = pd.read_csv("./submissions/submission_private_smp_unet_sampler_1024accum_bug.csv", dtype=str)

# smp_unet_sampler_alignaug_1024 5.0000000e-01 4.5000000e+03 do_tta True cut_borders from config
best_align = pd.read_csv("./submissions/submission_private_align_aug_tta_best.csv", dtype=str)
...
accu_bug_best = pd.read_csv("./submissions/submission_private_accum_bug_tta_best.csv", dtype=str)
