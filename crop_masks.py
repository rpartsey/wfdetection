...
for indx, image_path in enumerate(glob.glob(os.path.join(masks_root, 'train_1', '*.tif'))):
    ...
    with rasterio.open(image_path) as src:
        ...
        for row_off, col_off in window_offsets:
            ...
            dest_file_name = '{}_{}_{}.tif'.format(file_name.split('.')[0], (row_off // WINDOW_H) + 1,
                                                   (col_off // WINDOW_W) + 1)
            dest_path = os.path.join(cropped_masks_root, 'train_1', dest_file_name)
